...
function Create_Staff() {
  ...
  useEffect(() => {
    ...
    axios.get('https://eshiksh-mitra-project.vercel.app/api/v1/adminRoute/getAllEmployees', {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://eshiksh-mitra-project.vercel.app/api/v1/adminRoute/createEmployee",
        formDataToSend,
        {
          withCredentials: true,
      headers: {
  ...
  const handleDelete = (email) => {
    axios.put(`https://eshiksh-mitra-project.vercel.app/api/v1/adminRoute/deactivateEmployee`, { email }, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
