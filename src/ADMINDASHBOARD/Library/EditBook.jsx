...
const EditBook = () => {
  ...
  useEffect(() => {
    axios
    .get(
      `https://eshiksh-mitra-project.vercel.app/api/v1/adminRoute/getAllBooks?_id=${_id}`,
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    axios
      .put(`https://eshiksh-mitra-project.vercel.app/api/v1/adminRoute/updateBook/${_id}`, formData, 
      {
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${authToken}`,
