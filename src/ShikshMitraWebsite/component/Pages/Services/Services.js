  ...
  return (
    ...
    <main>
      ...
      >
        ...
        <div
          class="top-auto bottom-0 h-[70px] left-0 right-0 w-full absolute pointer-events-none overflow-hidden">
          <svg
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="flex flex-wrap items-center mt-32">
            <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              >
              By creating engaging and informative digital marketing content, you can effectively promote your School Management System to schools and 
              </p>
              <p
                class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700"
              >
               educational institutions looking to modernize their operations and improve the educational experience for students, teachers, and parents.
              </p>
             
            </div>
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
              <div
                class="relative flex flex-col min-w-0 break-words  w-full mb-6 shadow-lg rounded-lg bg-cyan-600"
              >
                <img
                  alt="..."
      ...
      <section class="relative py-20">
        <div
          class="bottom-auto top-0 h-[80px] transform translate-z-0left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20"
      ...
      <section class="pb-20 relative block bg-gray-900">
        <div
          class="bottom-auto top-0 left-0 h-[80px] right-0 w-full absolute pointer-events-none overflow-hidden -mt-20"
        //   style="height: 80px; transform: translateZ(0px);"
        >
          <svg
            class="absolute bottom-0 overflow-hidden"
