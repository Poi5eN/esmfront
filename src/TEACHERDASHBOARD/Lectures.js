...
const Lectures = () => {
  ...
  useEffect(() => {
    axios.get(`https://eshiksh-mitra-project.vercel.app/api/v1/timeTable/getClassTimeTable?className=${data.classTeacher}&section=${data.section}` , {
  ...
  const handleSubmit = async () => {
      ...
      await axios
      .post("https://eshiksh-mitra-project.vercel.app/api/v1/timeTable/createClassTimeTable", formattedTimetable, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
  ...
  const handleDelete = async() => {
    ...
    // https://eshiksh-mitra-project.vercel.app/api/v1/timeTable/deleteClassTimeTable/65449334131ddb58cb6de7f6
    await axios
      .delete(`https://eshiksh-mitra-project.vercel.app/api/v1/timeTable/deleteClassTimeTable/${timetableId}`, {
        withCredentials: true,
      headers: {
        Authorization: `Bearer ${authToken}`,
      },
